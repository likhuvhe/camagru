    ...
    <body>
        <div>
           <?php
            ...
            if ($_SESSION['userid']){
            echo "<center style='zoom: 1;'><form action='' method='POST' enctype='multipart/form-data'>
            <input type='file' name='image' id='image' style='zoom:200%;'>
            <button style='zoom: 200%;' type='submit' name='submit'>Upload</button>
            </form></center>";
            }
